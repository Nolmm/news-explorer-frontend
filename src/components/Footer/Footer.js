    ...
    <footer className="footer">
      ...
      <nav className="footer__navigation">
        <div className="footer__navigation_container">
          ...
          <a href="https://praktikum.yandex.ru/" target="_blank" className="footer__link" rel="noreferrer">Яндекс.Практикум</a>
        </div>
        <div className="footer__social">
            <a className="footer__social-link" href="https://github.com/Nolmm">
            ...
            <a className="footer__social-link" target="_blank" href="https://facebook.com" rel="noreferrer">
